...
public class PlayBarNextButton extends ImageView implements Observer {
	...
	public PlayBarNextButton(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public PlayBarNextButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public PlayBarNextButton(Context context) {
		super(context);
		init(context);
	}
	...
	protected void dispatchDraw(Canvas canvas) {
		if (!isLoadImage) {
			...
			ButtonIcon buttonIcon = skinInfo.getPlayBarNextButtonIcon();
			if (isPressed) {
