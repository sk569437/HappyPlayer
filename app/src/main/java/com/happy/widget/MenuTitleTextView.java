...
public class MenuTitleTextView extends TextView implements Observer {
	...
	public MenuTitleTextView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void dispatchDraw(Canvas canvas) {
		if (!isLoadColor) {
			...
			defColor = skinInfo.getMenuTitleColor();
