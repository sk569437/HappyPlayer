...
public class TBaseStatusBarRelativeLayout extends RelativeLayout implements
		Observer {

	public TBaseStatusBarRelativeLayout(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public TBaseStatusBarRelativeLayout(Context context) {
		super(context);
		init(context);
	}
