...
public class TabLeftRelativeLayout extends RelativeLayout implements Observer {
	...
	public TabLeftRelativeLayout(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public TabLeftRelativeLayout(Context context) {
		super(context);
		init(context);
	}
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		if (!isLoadColor) {
			...
			float[] roundRadius = { 10, 10, 0, 0, 0, 0, 10, 10 }; // 圆角半径
