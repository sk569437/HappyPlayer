...
public class SecondTextView extends TextView implements Observer {
	...
	public SecondTextView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void dispatchDraw(Canvas canvas) {
		if (!isLoadColor) {
			...
			Text commonTitleText = skinInfo.getCommonSubTitleText();
