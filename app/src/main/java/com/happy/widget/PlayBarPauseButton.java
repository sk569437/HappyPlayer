...
public class PlayBarPauseButton extends ImageView implements Observer {
	...
	public PlayBarPauseButton(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public PlayBarPauseButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public PlayBarPauseButton(Context context) {
		super(context);
		init(context);
	}
	...
	protected void dispatchDraw(Canvas canvas) {
		if (!isLoadImage) {
			...
			ButtonIcon buttonIcon = skinInfo.getPlayBarPauseButtonIcon();
			if (isPressed) {
