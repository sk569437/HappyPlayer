...
public class PlayBarSidebarButton extends ImageView implements Observer {
	...
	public PlayBarSidebarButton(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public PlayBarSidebarButton(Context context) {
		super(context);
		init(context);
	}
	...
	protected void dispatchDraw(Canvas canvas) {
		if (!isLoadImage) {
			...
			ButtonIcon buttonIcon = skinInfo.getPlayBarSidebarIcon();
			if (isPressed) {
